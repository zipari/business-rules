...
class OperatorsClassTests(TestCase):
    ...
    def test_get_all_operators(self):
        """
            Returns a dictionary listing all the operators on the class that can be called on that type,
            with some data about them.
        """
    ...
    def test_operator_decorator_casts_argument(self):
        """
            Any operator that has the @type_operator decorator should call _assert_valid_value_and_cast on the parameter
        """
